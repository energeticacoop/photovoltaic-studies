/**
 * Processes conventional consumption and production data.
 * 1. Get normalized curve from selected CCH source
 * 2. Match production and consumption curves dates
 * 3. Output consumptions curves, nightly inverter consumption data and cummulative consumption values
 */
...
/**
 * Removes February 29th data from the array.
 * @param {Array<Object>} cch - The array of consumption data.
 */
...
/**
 * Trims the consumption data to the last natural year.
 * @param {Array<Object>} cch - The array of consumption data.
 */
...
/**
 * Normalizes the consumption data for CNMC format, adjusting for daylight saving time (DST).
 * @param {Array<Object>} cch - The array of consumption data.
 * @returns {Array<Object>} The normalized consumption data.
 */
...
/**
 * Normalizes the consumption data for Infoenergia format, adjusting for DST.
 * @param {Array<Object>} cch - The array of consumption data.
 * @returns {Array<Object>} The normalized consumption data.
 */
...
/**
 * Completes missing values in the consumption data to represent a full year (8760 hours).
 * @param {Array<Object>} cch - The array of consumption data.
 * @returns {Array<Object>} The completed consumption data.
 */
...
/**
 * Processes consumption data in the Infoenergia format.
...
/**
 * Processes consumption data in the Datadis CSV format.
 * @returns {Array<Object>} The processed consumption data.
 */
...
/**
 * Processes consumption data in the CNMC format.
 * @returns {Array<Object>} The processed consumption data.
 */
...
/**
 * Processes consumption data in the REE format.
 * @returns {Array<Object>} The processed consumption data.
 */
function processREE() {
...
/**
 * Processes consumption data in the SIPS 2.0 format.
 * @returns {Array<Object>} The processed consumption data.
 */
...
/**
 * Processes consumption data in the SIPS 3.0 format.
 * @returns {Array<Object>} The processed consumption data.
 */
