...
/**
 * Retrieves satellite images from Google Static Maps API and calculates its scales (meters per 100 píxels).
 */
...
/**
 * Retrieves UTM coordinates.
 * Code taken from https://github.com/TimothyGu/utm
 */
